      ...
      <div className="bg-zinc-950 p-4 h-full">
        <div className="flex justify-between">
          <div className="text-white">
            <button onClick={()=> tool?.set(false)} type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-zinc-800 rounded-lg text-sm h-8 w-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-700 dark:hover:text-white" data-modal-toggle="course-modal">
